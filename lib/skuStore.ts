...
import { SKU, Category, CreateSKUDto, UpdateSKUDto, CreateCategoryDto, UpdateCategoryDto, SKUFilterParams, SKUStatus } from '@/types/sku'
...
export function initSampleData() {
  if (categories.length === 0) {
    ...
    const cat3 = categoryStore.create({ name: 'Carbon Fiber', slug: 'carbon-fiber', parent_id: cat1.id })
