          ...
          >
            ...
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10">
              <p className="text-white/70 leading-relaxed">
                {design.description ||
                  'Premium vinyl wrap design featuring high-quality 3M material with professional installation included. This design transforms your scooter with stunning visuals while protecting the original paint.'}
              </p>
            </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3 text-white/70">
                    <svg
                      className="w-5 h-5 text-[#00FFA9] flex-shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                      <path
