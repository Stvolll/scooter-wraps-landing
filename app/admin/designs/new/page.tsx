        ...
        >
          <form action={handleSubmit} className="space-y-4">
            ...
            <div className="pt-6 border-t border-white/10">
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-white mb-2">📁 Пакетная загрузка файлов</h3>
                <p className="text-sm text-white/60 mb-4">
                  Загрузите все необходимые файлы для дизайна одним пакетом. Все файлы автоматически загружаются в S3 хранилище.
                </p>
                <p className="text-xs text-white/40 mb-4">
                  💡 <strong>Совет:</strong> Сначала создайте дизайн, затем загрузите файлы через страницу редактирования для пакетной загрузки.
                </p>
              </div>
