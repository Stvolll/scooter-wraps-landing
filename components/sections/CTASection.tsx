      ...
      <div className="relative container mx-auto px-4 md:px-8 lg:px-16">
        ...
        >
          ...
          >
            ...
            <span className="font-semibold text-[#FFB800]">{t('cta.limitedOffer')}</span>
          </motion.div>
          ...
          >
            ...
            {/* Secondary CTA */}
            <button className="px-8 py-4 rounded-2xl font-semibold text-white border-2 border-white/20 hover:border-[#00FFA9] hover:bg-white/5 transition-all duration-300 w-full sm:w-auto">
