...
function RotationTracker({ onRotationChange }: { onRotationChange: (angle: number) => void }) {
  ...
  return <OrbitControls ref={controlsRef} enableZoom={true} enablePan={false} autoRotate={false} />
}
